...
from customer_revenue.entity.config_entity import DataIngestionConfig
from customer_revenue.entity.metadata_entity import DataIngestionMetadata
from customer_revenue.exception import CustomerException
from customer_revenue.logging import logger
from datetime import datetime
# from customer_revenue.constant.environment.variable_key import KAGGLE_DATA_USERNAME
...
class DataIngestion:
    ...
    def download_data(self):
        try:
            ...
            # downloading data
            api.competition_download_files(f'{dataset_name}', path=download_dir)
