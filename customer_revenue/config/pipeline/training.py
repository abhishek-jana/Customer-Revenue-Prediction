...
from customer_revenue.entity.config_entity import DataIngestionConfig, TrainingPipelineConfig
from customer_revenue.constant.training_pipeline_config import *
from customer_revenue.constant import TIMESTAMP
